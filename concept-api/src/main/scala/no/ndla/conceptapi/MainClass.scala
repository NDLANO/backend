...
class MainClass(props: ConceptApiProperties) extends LazyLogging {
  ...
  def startServer(): Server = {
    ...
    context.setInitParameter("org.scalatra.LifeCycle", "no.ndla.conceptapi.ScalatraBootstrap")
    ...
    // Necessary to mount ComponentRegistry members in no.ndla.conceptapi.ScalatraBootstrap
