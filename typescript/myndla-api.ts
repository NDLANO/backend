...
export type ResourceType = (IImage | IArticle | ILearningpath | IConcept | IVideo | IAudio | IMultidisciplinary)

export type ResourceType = (IAudio | IVideo | IImage | IArticle | IConcept | IMultidisciplinary | ILearningpath)
