...
export type ResourceType = (IImage | IMultidisciplinary | IAudio | ILearningpath | IConcept | IVideo | IArticle)

export type ResourceType = (IMultidisciplinary | IAudio | IVideo | ILearningpath | IArticle | IImage | IConcept)
