...
export type ResourceType = (IMultidisciplinary | ILearningpath | IAudio | IVideo | IConcept | IImage | IArticle)

export type ResourceType = (IMultidisciplinary | IAudio | IConcept | IImage | IArticle | IVideo | ILearningpath)
