...
object TestData {
  ...
  private val publicDomainCopyright = Copyright("publicdomain", None, List(), List(), List(), None, None)
  private val byNcSaCopyright =
    Copyright("by-nc-sa", Some("Gotham City"), List(Author("Writer", "DC Comics")), List(), List(), None, None)
  private val copyrighted =
    Copyright("copyrighted", Some("New York"), List(Author("Writer", "Clark Kent")), List(), List(), None, None)
  ...
  val emptyDomainArticle: Article = Article(
    ...
    title = Seq.empty,
    content = Seq.empty,
    copyright = Copyright("", None, Seq.empty, Seq.empty, Seq.empty, None, None),
    tags = Seq.empty,
  ...
  val draftPublicDomainCopyright: draft.DraftCopyright =
    draft.DraftCopyright(Some("publicdomain"), Some(""), List.empty, List(), List(), None, None)
