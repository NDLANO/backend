...
export type ResourceType = (IImage | IConcept | IArticle | IVideo | IMultidisciplinary | ILearningpath | IAudio)

export type ResourceType = (ILearningpath | IConcept | IArticle | IVideo | IAudio | IImage | IMultidisciplinary)
