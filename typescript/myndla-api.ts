...
export type ResourceType = (ILearningpath | IMultidisciplinary | IConcept | IImage | IArticle | IVideo | IAudio)

export type ResourceType = (IMultidisciplinary | IImage | IVideo | IAudio | ILearningpath | IArticle | IConcept)
