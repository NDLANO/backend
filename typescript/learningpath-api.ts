...
export type ResourceType = (IArticle | ILearningpath | IImage | IMultidisciplinary | IAudio | IVideo | IConcept)

export type ResourceType = (IConcept | ILearningpath | IArticle | IMultidisciplinary | IAudio | IImage | IVideo)
