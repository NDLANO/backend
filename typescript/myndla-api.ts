...
export type ResourceType = (IImage | IArticle | IConcept | IVideo | IMultidisciplinary | ILearningpath | IAudio)

export type ResourceType = (IConcept | IArticle | IMultidisciplinary | IImage | ILearningpath | IVideo | IAudio)
