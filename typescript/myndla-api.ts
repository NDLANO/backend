...
export type ResourceType = (IVideo | IImage | IArticle | IMultidisciplinary | IConcept | IAudio | ILearningpath)

export type ResourceType = (IVideo | IArticle | IAudio | IConcept | IImage | ILearningpath | IMultidisciplinary)
