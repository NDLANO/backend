...
export type ResourceType = (IArticle | ILearningpath | IVideo | IConcept | IAudio | IMultidisciplinary | IImage)

export type ResourceType = (IMultidisciplinary | IAudio | IImage | IArticle | IConcept | ILearningpath | IVideo)
