...
export type ResourceType = (IVideo | IMultidisciplinary | IConcept | ILearningpath | IAudio | IImage | IArticle)

export type ResourceType = (IArticle | IMultidisciplinary | IImage | IAudio | IConcept | IVideo | ILearningpath)
