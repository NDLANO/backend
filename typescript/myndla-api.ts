...
export type ResourceType = (ILearningpath | IArticle | IVideo | IAudio | IConcept | IImage | IMultidisciplinary)

export type ResourceType = (IVideo | IMultidisciplinary | ILearningpath | IConcept | IImage | IAudio | IArticle)
