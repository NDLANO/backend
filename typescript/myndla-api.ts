...
export type ResourceType = (IImage | ILearningpath | IConcept | IVideo | IArticle | IAudio | IMultidisciplinary)

export type ResourceType = (IVideo | IArticle | ILearningpath | IAudio | IConcept | IImage | IMultidisciplinary)
