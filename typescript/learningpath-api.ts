...
export type ResourceType = (IAudio | IConcept | IVideo | ILearningpath | IMultidisciplinary | IImage | IArticle)

export type ResourceType = (IVideo | IMultidisciplinary | IArticle | IImage | IAudio | ILearningpath | IConcept)
