...
export type ResourceType = (IConcept | IImage | IArticle | IMultidisciplinary | IAudio | ILearningpath | IVideo)

export type ResourceType = (IImage | IConcept | IAudio | ILearningpath | IVideo | IMultidisciplinary | IArticle)
