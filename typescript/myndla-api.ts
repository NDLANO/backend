...
export type ResourceType = (IArticle | IImage | IMultidisciplinary | IAudio | IConcept | IVideo | ILearningpath)

export type ResourceType = (IVideo | IImage | IArticle | ILearningpath | IAudio | IMultidisciplinary | IConcept)
