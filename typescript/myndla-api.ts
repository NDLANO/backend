...
export type ResourceType = (IConcept | ILearningpath | IAudio | IMultidisciplinary | IImage | IArticle | IVideo)

export type ResourceType = (IAudio | ILearningpath | IArticle | IMultidisciplinary | IImage | IVideo | IConcept)
