...
export type ResourceType = (IImage | IVideo | ILearningpath | IMultidisciplinary | IConcept | IArticle | IAudio)

export type ResourceType = (IMultidisciplinary | IVideo | IAudio | IConcept | IArticle | ILearningpath | IImage)
