...
export type ResourceType = (IVideo | IAudio | ILearningpath | IArticle | IMultidisciplinary | IConcept | IImage)

export type ResourceType = (IVideo | ILearningpath | IArticle | IConcept | IAudio | IImage | IMultidisciplinary)
