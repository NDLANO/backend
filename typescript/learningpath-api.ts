...
export type ResourceType = (IVideo | IArticle | IImage | ILearningpath | IAudio | IMultidisciplinary | IConcept)

export type ResourceType = (IVideo | IArticle | IImage | IConcept | ILearningpath | IMultidisciplinary | IAudio)
