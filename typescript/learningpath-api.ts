...
export type ResourceType = (IMultidisciplinary | IImage | IVideo | IArticle | ILearningpath | IConcept | IAudio)

export type ResourceType = (IVideo | IArticle | IImage | IAudio | IConcept | ILearningpath | IMultidisciplinary)
