...
export type ResourceType = (IVideo | IMultidisciplinary | IImage | IConcept | ILearningpath | IAudio | IArticle)

export type ResourceType = (ILearningpath | IImage | IArticle | IAudio | IMultidisciplinary | IVideo | IConcept)
