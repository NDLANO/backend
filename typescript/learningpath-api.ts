...
export type ResourceType = (IConcept | IArticle | ILearningpath | IMultidisciplinary | IAudio | IVideo | IImage)

export type ResourceType = (IImage | ILearningpath | IAudio | IMultidisciplinary | IArticle | IConcept | IVideo)
