...
export type ResourceType = (IArticle | IConcept | IVideo | ILearningpath | IImage | IAudio | IMultidisciplinary)

export type ResourceType = (ILearningpath | IArticle | IConcept | IAudio | IMultidisciplinary | IVideo | IImage)
