...
export type ResourceType = (IConcept | IVideo | IAudio | IArticle | IMultidisciplinary | ILearningpath | IImage)

export type ResourceType = (IArticle | IMultidisciplinary | IConcept | IVideo | ILearningpath | IImage | IAudio)
