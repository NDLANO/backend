...
export type ResourceType = (IMultidisciplinary | IImage | IAudio | ILearningpath | IArticle | IVideo | IConcept)

export type ResourceType = (IAudio | IConcept | IMultidisciplinary | IVideo | IArticle | IImage | ILearningpath)
