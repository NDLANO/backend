...
export type ResourceType = (IMultidisciplinary | IImage | ILearningpath | IArticle | IAudio | IConcept | IVideo)

export type ResourceType = (IVideo | IAudio | IImage | IMultidisciplinary | IConcept | IArticle | ILearningpath)
