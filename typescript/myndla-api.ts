...
export type ResourceType = (IVideo | IImage | IArticle | ILearningpath | IMultidisciplinary | IConcept | IAudio)

export type ResourceType = (IMultidisciplinary | IAudio | IVideo | IImage | ILearningpath | IConcept | IArticle)
