...
export type ResourceType = (IAudio | IConcept | ILearningpath | IArticle | IVideo | IImage | IMultidisciplinary)

export type ResourceType = (ILearningpath | IImage | IArticle | IVideo | IConcept | IMultidisciplinary | IAudio)
