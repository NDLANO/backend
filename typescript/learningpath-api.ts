...
export type ResourceType = (IConcept | IAudio | ILearningpath | IArticle | IVideo | IMultidisciplinary | IImage)

export type ResourceType = (IArticle | IMultidisciplinary | IImage | ILearningpath | IAudio | IConcept | IVideo)
