...
export type ResourceType = (IConcept | IMultidisciplinary | IImage | IAudio | ILearningpath | IVideo | IArticle)

export type ResourceType = (IMultidisciplinary | IArticle | IVideo | IImage | ILearningpath | IAudio | IConcept)
