...
export type ResourceType = (IArticle | IAudio | ILearningpath | IConcept | IMultidisciplinary | IImage | IVideo)

export type ResourceType = (ILearningpath | IImage | IConcept | IAudio | IMultidisciplinary | IArticle | IVideo)
