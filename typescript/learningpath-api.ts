...
export type ResourceType = (IConcept | IMultidisciplinary | IImage | IArticle | ILearningpath | IVideo | IAudio)

export type ResourceType = (IAudio | IConcept | IMultidisciplinary | IImage | IArticle | IVideo | ILearningpath)
