...
export type ResourceType = (IMultidisciplinary | IVideo | IArticle | IImage | ILearningpath | IAudio | IConcept)

export type ResourceType = (IMultidisciplinary | IVideo | IArticle | IImage | IConcept | ILearningpath | IAudio)
