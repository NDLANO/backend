...
export type ResourceType = (IVideo | IImage | IAudio | IArticle | ILearningpath | IConcept | IMultidisciplinary)

export type ResourceType = (IVideo | IMultidisciplinary | IArticle | IConcept | IAudio | IImage | ILearningpath)
