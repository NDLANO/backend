...
export type ResourceType = (IConcept | IArticle | IAudio | IImage | ILearningpath | IVideo | IMultidisciplinary)

export type ResourceType = (IArticle | IVideo | IImage | IConcept | IAudio | ILearningpath | IMultidisciplinary)
