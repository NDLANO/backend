...
export type ResourceType = (IAudio | IArticle | ILearningpath | IVideo | IMultidisciplinary | IImage | IConcept)

export type ResourceType = (IImage | IVideo | IMultidisciplinary | IConcept | ILearningpath | IAudio | IArticle)
