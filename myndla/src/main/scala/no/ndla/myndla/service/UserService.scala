  ...
  class UserService {
    ...
    private def updateFeideUserDataAuthenticated(
      ...
      for {
        ...
        combined = folderConverterService.mergeUserData(existingUserData, updatedUser, None, existingUserData)
      ...
      feideId match {
        ...
        case Some(id) =>
          for {
            ...
            converted = folderConverterService.mergeUserData(existing, updatedUser, Some(user), updater)
