...
export type ResourceType = (IArticle | IAudio | ILearningpath | IMultidisciplinary | IVideo | IImage | IConcept)

export type ResourceType = (IConcept | IMultidisciplinary | IImage | IArticle | IAudio | ILearningpath | IVideo)
