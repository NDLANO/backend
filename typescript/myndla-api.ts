...
export type ResourceType = (IVideo | IAudio | ILearningpath | IImage | IConcept | IMultidisciplinary | IArticle)

export type ResourceType = (IConcept | IImage | ILearningpath | IAudio | IMultidisciplinary | IArticle | IVideo)
