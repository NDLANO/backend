...
export type ResourceType = (IImage | IVideo | IMultidisciplinary | IArticle | IAudio | IConcept | ILearningpath)

export type ResourceType = (ILearningpath | IAudio | IVideo | IImage | IConcept | IArticle | IMultidisciplinary)
