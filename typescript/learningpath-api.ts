...
export type ResourceType = (IConcept | IArticle | IAudio | ILearningpath | IImage | IMultidisciplinary | IVideo)

export type ResourceType = (IArticle | IImage | IAudio | IMultidisciplinary | ILearningpath | IVideo | IConcept)
