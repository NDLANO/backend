...
export type ResourceType = (ILearningpath | IMultidisciplinary | IAudio | IArticle | IConcept | IVideo | IImage)

export type ResourceType = (ILearningpath | IArticle | IVideo | IConcept | IMultidisciplinary | IAudio | IImage)
