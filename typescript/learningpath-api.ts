...
export type ResourceType = (IAudio | IConcept | IMultidisciplinary | IArticle | IImage | IVideo | ILearningpath)

export type ResourceType = (IConcept | IAudio | IArticle | IImage | IVideo | IMultidisciplinary | ILearningpath)
