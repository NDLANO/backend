...
export type ResourceType = (IVideo | IMultidisciplinary | IAudio | IConcept | ILearningpath | IArticle | IImage)

export type ResourceType = (IConcept | IVideo | IImage | ILearningpath | IAudio | IArticle | IMultidisciplinary)
