...
export type ResourceType = (IVideo | IConcept | ILearningpath | IArticle | IImage | IAudio | IMultidisciplinary)

export type ResourceType = (IMultidisciplinary | IArticle | IImage | ILearningpath | IConcept | IVideo | IAudio)
