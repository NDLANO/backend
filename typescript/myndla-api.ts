...
export type ResourceType = (IImage | ILearningpath | IAudio | IArticle | IMultidisciplinary | IConcept | IVideo)

export type ResourceType = (IMultidisciplinary | IImage | IArticle | ILearningpath | IVideo | IAudio | IConcept)
