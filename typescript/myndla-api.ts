...
export type ResourceType = (IImage | IVideo | ILearningpath | IArticle | IAudio | IConcept | IMultidisciplinary)

export type ResourceType = (IImage | IConcept | IVideo | IMultidisciplinary | IArticle | ILearningpath | IAudio)
