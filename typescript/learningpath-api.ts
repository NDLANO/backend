...
export type ResourceType = (IAudio | IImage | IMultidisciplinary | ILearningpath | IVideo | IArticle | IConcept)

export type ResourceType = (IArticle | ILearningpath | IConcept | IAudio | IMultidisciplinary | IImage | IVideo)
