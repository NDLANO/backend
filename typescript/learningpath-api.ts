...
export type ResourceType = (IArticle | IImage | IAudio | IConcept | IMultidisciplinary | ILearningpath | IVideo)

export type ResourceType = (IArticle | IAudio | IVideo | IImage | IConcept | ILearningpath | IMultidisciplinary)
