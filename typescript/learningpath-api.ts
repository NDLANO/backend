...
export type ResourceType = (IVideo | IArticle | ILearningpath | IMultidisciplinary | IImage | IConcept | IAudio)

export type ResourceType = (IConcept | IImage | IArticle | IMultidisciplinary | IVideo | ILearningpath | IAudio)
