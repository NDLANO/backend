...
export type ResourceType = (IAudio | IArticle | IMultidisciplinary | IConcept | IVideo | IImage | ILearningpath)

export type ResourceType = (ILearningpath | IVideo | IImage | IAudio | IMultidisciplinary | IArticle | IConcept)
