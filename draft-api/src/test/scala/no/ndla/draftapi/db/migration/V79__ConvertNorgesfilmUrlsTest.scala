...
class V79__ConvertNorgesfilmUrlsTest extends UnitSuite with TestEnvironment {
  test("That norgesfilm urls looses ndlafilm.aspx") {
    val migration  = new V79__ConvertNorgesfilmUrls
    val oldArticle =
    ...
    val newArticle =
      """<section><ndlaembed data-resource="iframe" data-type="iframe" data-url="https://ndla2.filmiundervisning.no/film/13074" data-width="700" data-height="300"></ndlaembed></section>"""
