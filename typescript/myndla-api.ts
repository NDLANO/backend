...
export type ResourceType = (ILearningpath | IConcept | IAudio | IImage | IMultidisciplinary | IVideo | IArticle)

export type ResourceType = (IMultidisciplinary | IAudio | ILearningpath | IVideo | IArticle | IConcept | IImage)
