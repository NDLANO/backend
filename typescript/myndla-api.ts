...
export type ResourceType = (ILearningpath | IMultidisciplinary | IImage | IVideo | IArticle | IConcept | IAudio)

export type ResourceType = (IAudio | IVideo | IImage | ILearningpath | IMultidisciplinary | IConcept | IArticle)
