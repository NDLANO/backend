...
export type ResourceType = (IAudio | IMultidisciplinary | IImage | IArticle | ILearningpath | IConcept | IVideo)

export type ResourceType = (ILearningpath | IAudio | IConcept | IArticle | IMultidisciplinary | IImage | IVideo)
