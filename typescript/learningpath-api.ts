...
export type ResourceType = (ILearningpath | IArticle | IVideo | IAudio | IMultidisciplinary | IConcept | IImage)

export type ResourceType = (IAudio | IConcept | ILearningpath | IVideo | IImage | IArticle | IMultidisciplinary)
