...
export type ResourceType = (IVideo | IMultidisciplinary | IArticle | IConcept | ILearningpath | IAudio | IImage)

export type ResourceType = (IMultidisciplinary | IVideo | IArticle | IImage | IAudio | ILearningpath | IConcept)
