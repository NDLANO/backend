...
export type ResourceType = (IArticle | IAudio | IVideo | IImage | IConcept | IMultidisciplinary | ILearningpath)

export type ResourceType = (IAudio | IArticle | IVideo | IConcept | IImage | IMultidisciplinary | ILearningpath)
