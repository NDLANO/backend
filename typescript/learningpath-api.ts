...
export type ResourceType = (IVideo | IMultidisciplinary | IConcept | IImage | IArticle | IAudio | ILearningpath)

export type ResourceType = (ILearningpath | IImage | IVideo | IConcept | IArticle | IMultidisciplinary | IAudio)
