...
case class ImageMetaInformationV3(
    ...
    @(ApiModelProperty @field)(description = "Describes when the image was created") created: NDLADate,
    ...
    @(ApiModelProperty @field)(description = "Describes the image file") image: ImageFile
)
