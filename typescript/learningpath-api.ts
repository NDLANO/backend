...
export type ResourceType = (IImage | IConcept | ILearningpath | IArticle | IAudio | IMultidisciplinary | IVideo)

export type ResourceType = (IVideo | IConcept | IAudio | IImage | ILearningpath | IMultidisciplinary | IArticle)
