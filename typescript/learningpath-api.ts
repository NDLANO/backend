...
export type ResourceType = (IConcept | ILearningpath | IVideo | IMultidisciplinary | IAudio | IImage | IArticle)

export type ResourceType = (IConcept | IVideo | IArticle | IMultidisciplinary | IAudio | IImage | ILearningpath)
