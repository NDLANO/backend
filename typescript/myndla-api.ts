...
export type ResourceType = (IConcept | IMultidisciplinary | IArticle | IVideo | IAudio | IImage | ILearningpath)

export type ResourceType = (IArticle | IAudio | IImage | IVideo | ILearningpath | IMultidisciplinary | IConcept)
