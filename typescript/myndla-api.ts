...
export type ResourceType = (ILearningpath | IConcept | IImage | IVideo | IAudio | IArticle | IMultidisciplinary)

export type ResourceType = (IImage | IConcept | IMultidisciplinary | ILearningpath | IArticle | IVideo | IAudio)
