...
export type ResourceType = (IAudio | IImage | ILearningpath | IConcept | IMultidisciplinary | IArticle | IVideo)

export type ResourceType = (IArticle | IVideo | ILearningpath | IConcept | IMultidisciplinary | IImage | IAudio)
