...
export type ResourceType = (IArticle | IImage | IConcept | ILearningpath | IMultidisciplinary | IVideo | IAudio)

export type ResourceType = (IConcept | IMultidisciplinary | IArticle | ILearningpath | IAudio | IImage | IVideo)
