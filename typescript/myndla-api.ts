...
export type ResourceType = (IArticle | IVideo | ILearningpath | IImage | IMultidisciplinary | IConcept | IAudio)

export type ResourceType = (ILearningpath | IAudio | IMultidisciplinary | IVideo | IConcept | IImage | IArticle)
