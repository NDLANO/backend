...
export type ResourceType = (IAudio | IMultidisciplinary | ILearningpath | IConcept | IImage | IArticle | IVideo)

export type ResourceType = (IConcept | IMultidisciplinary | IVideo | IArticle | ILearningpath | IImage | IAudio)
