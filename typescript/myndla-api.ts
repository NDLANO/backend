...
export type ResourceType = (IConcept | ILearningpath | IImage | IMultidisciplinary | IArticle | IVideo | IAudio)

export type ResourceType = (IArticle | IConcept | ILearningpath | IMultidisciplinary | IImage | IAudio | IVideo)
