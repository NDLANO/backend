...
export type ResourceType = (IAudio | IMultidisciplinary | IConcept | ILearningpath | IArticle | IImage | IVideo)

export type ResourceType = (IAudio | IMultidisciplinary | IConcept | ILearningpath | IVideo | IImage | IArticle)
