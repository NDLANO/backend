...
export type ResourceType = (ILearningpath | IMultidisciplinary | IConcept | IAudio | IImage | IArticle | IVideo)

export type ResourceType = (IArticle | IMultidisciplinary | IConcept | IImage | IVideo | IAudio | ILearningpath)
