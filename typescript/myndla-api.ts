...
export type ResourceType = (IVideo | IConcept | ILearningpath | IImage | IArticle | IMultidisciplinary | IAudio)

export type ResourceType = (IAudio | ILearningpath | IArticle | IVideo | IImage | IMultidisciplinary | IConcept)
