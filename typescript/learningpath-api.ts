...
export type ResourceType = (IConcept | ILearningpath | IArticle | IAudio | IImage | IVideo | IMultidisciplinary)

export type ResourceType = (IMultidisciplinary | IConcept | IAudio | IImage | IVideo | IArticle | ILearningpath)
