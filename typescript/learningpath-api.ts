...
export type ResourceType = (IVideo | IArticle | IMultidisciplinary | ILearningpath | IConcept | IImage | IAudio)

export type ResourceType = (IConcept | IVideo | IAudio | ILearningpath | IImage | IArticle | IMultidisciplinary)
