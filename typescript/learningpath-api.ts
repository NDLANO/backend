...
export type ResourceType = (ILearningpath | IAudio | IImage | IMultidisciplinary | IArticle | IConcept | IVideo)

export type ResourceType = (ILearningpath | IArticle | IVideo | IImage | IConcept | IMultidisciplinary | IAudio)
