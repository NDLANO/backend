...
export type ResourceType = (IConcept | IMultidisciplinary | IAudio | IVideo | ILearningpath | IArticle | IImage)

export type ResourceType = (ILearningpath | IConcept | IAudio | IImage | IArticle | IMultidisciplinary | IVideo)
