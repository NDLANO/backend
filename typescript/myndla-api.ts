...
export type ResourceType = (ILearningpath | IAudio | IConcept | IMultidisciplinary | IVideo | IImage | IArticle)

export type ResourceType = (ILearningpath | IMultidisciplinary | IAudio | IConcept | IVideo | IArticle | IImage)
