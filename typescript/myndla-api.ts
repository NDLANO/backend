...
export type ResourceType = (IArticle | ILearningpath | IConcept | IAudio | IImage | IMultidisciplinary | IVideo)

export type ResourceType = (IArticle | IVideo | IConcept | IAudio | IMultidisciplinary | IImage | ILearningpath)
