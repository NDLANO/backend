...
class LicenseTest extends UnitSuite {
  test("getLicense returns a LicenseDefinition if input code is vaid") {
    val expectedResult = Some(LicenseDefinition(License.CC_BY, "Creative Commons Attribution 4.0 International", Some("https://creativecommons.org/licenses/by/4.0/")))
  ...
  test("getLicenses returns a list of all licenses") {
    val byLicense = LicenseDefinition(License.CC_BY, "Creative Commons Attribution 4.0 International", Some("https://creativecommons.org/licenses/by/4.0/"))
