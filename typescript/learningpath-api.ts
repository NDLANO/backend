...
export type ResourceType = (IVideo | IAudio | ILearningpath | IMultidisciplinary | IImage | IConcept | IArticle)

export type ResourceType = (IAudio | IConcept | IArticle | IVideo | ILearningpath | IImage | IMultidisciplinary)
