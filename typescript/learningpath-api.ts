...
export type ResourceType = (IConcept | IAudio | IArticle | IVideo | IImage | ILearningpath | IMultidisciplinary)

export type ResourceType = (IConcept | IImage | ILearningpath | IAudio | IArticle | IMultidisciplinary | IVideo)
