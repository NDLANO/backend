...
export type ResourceType = (IMultidisciplinary | IConcept | IAudio | IVideo | IImage | IArticle | ILearningpath)

export type ResourceType = (IArticle | IConcept | IVideo | IImage | IAudio | IMultidisciplinary | ILearningpath)
