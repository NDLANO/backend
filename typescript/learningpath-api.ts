...
export type ResourceType = (IImage | IArticle | IConcept | ILearningpath | IVideo | IAudio | IMultidisciplinary)

export type ResourceType = (IAudio | IImage | IConcept | IArticle | IMultidisciplinary | ILearningpath | IVideo)
