...
export type ResourceType = (IVideo | IArticle | IAudio | IMultidisciplinary | ILearningpath | IConcept | IImage)

export type ResourceType = (IMultidisciplinary | IAudio | ILearningpath | IVideo | IImage | IArticle | IConcept)
