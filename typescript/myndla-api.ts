...
export type ResourceType = (IVideo | IImage | IArticle | IConcept | IMultidisciplinary | ILearningpath | IAudio)

export type ResourceType = (IMultidisciplinary | IVideo | IImage | IConcept | ILearningpath | IAudio | IArticle)
