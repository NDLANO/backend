...
export type ResourceType = (IVideo | IArticle | IMultidisciplinary | ILearningpath | IConcept | IAudio | IImage)

export type ResourceType = (IConcept | ILearningpath | IArticle | IVideo | IAudio | IImage | IMultidisciplinary)
