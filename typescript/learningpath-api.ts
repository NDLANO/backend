...
export type ResourceType = (IAudio | IVideo | IArticle | ILearningpath | IConcept | IMultidisciplinary | IImage)

export type ResourceType = (IMultidisciplinary | IImage | ILearningpath | IVideo | IConcept | IArticle | IAudio)
