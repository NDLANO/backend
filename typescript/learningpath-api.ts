...
export type ResourceType = (IImage | IAudio | IConcept | IMultidisciplinary | IArticle | ILearningpath | IVideo)

export type ResourceType = (IArticle | IMultidisciplinary | IVideo | ILearningpath | IConcept | IImage | IAudio)
