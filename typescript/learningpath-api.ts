...
export type ResourceType = (IMultidisciplinary | IAudio | IImage | ILearningpath | IConcept | IVideo | IArticle)

export type ResourceType = (IConcept | IVideo | IMultidisciplinary | IAudio | IImage | IArticle | ILearningpath)
