...
export type ResourceType = (IAudio | IConcept | IVideo | IArticle | IMultidisciplinary | ILearningpath | IImage)

export type ResourceType = (IArticle | IImage | IAudio | IConcept | ILearningpath | IVideo | IMultidisciplinary)
