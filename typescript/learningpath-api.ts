...
export type ResourceType = (IArticle | IImage | IMultidisciplinary | IVideo | IAudio | IConcept | ILearningpath)

export type ResourceType = (IConcept | IVideo | ILearningpath | IAudio | IMultidisciplinary | IArticle | IImage)
