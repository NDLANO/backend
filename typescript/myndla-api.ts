...
export type ResourceType = (IImage | IConcept | IArticle | ILearningpath | IAudio | IMultidisciplinary | IVideo)

export type ResourceType = (IAudio | IMultidisciplinary | ILearningpath | IArticle | IVideo | IConcept | IImage)
