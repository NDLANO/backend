...
export type ResourceType = (IVideo | IArticle | IAudio | IConcept | ILearningpath | IMultidisciplinary | IImage)

export type ResourceType = (IMultidisciplinary | IAudio | IConcept | IVideo | IArticle | ILearningpath | IImage)
