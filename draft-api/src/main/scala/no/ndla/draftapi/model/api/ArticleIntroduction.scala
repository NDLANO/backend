...
case class ArticleIntroduction(
    @(ApiModelProperty @field)(description = "The html introduction content") introduction: String,
    @(ApiModelProperty @field)(description = "The plaintext introduction content") plainIntroduction: String,
