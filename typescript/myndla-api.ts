...
export type ResourceType = (IVideo | IAudio | ILearningpath | IArticle | IConcept | IMultidisciplinary | IImage)

export type ResourceType = (IMultidisciplinary | IConcept | IAudio | IImage | IVideo | ILearningpath | IArticle)
