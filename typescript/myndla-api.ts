...
export type ResourceType = (IAudio | ILearningpath | IVideo | IImage | IConcept | IArticle | IMultidisciplinary)

export type ResourceType = (IVideo | IArticle | IImage | IConcept | IMultidisciplinary | ILearningpath | IAudio)
