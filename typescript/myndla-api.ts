...
export type ResourceType = (IMultidisciplinary | IVideo | IConcept | IArticle | IImage | ILearningpath | IAudio)

export type ResourceType = (IArticle | IMultidisciplinary | IVideo | IImage | IAudio | IConcept | ILearningpath)
