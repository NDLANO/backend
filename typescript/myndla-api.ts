...
export type ResourceType = (IAudio | IMultidisciplinary | IConcept | ILearningpath | IImage | IVideo | IArticle)

export type ResourceType = (IConcept | ILearningpath | IImage | IArticle | IVideo | IAudio | IMultidisciplinary)
