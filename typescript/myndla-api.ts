...
export type ResourceType = (ILearningpath | IVideo | IArticle | IMultidisciplinary | IAudio | IImage | IConcept)

export type ResourceType = (IArticle | IImage | IMultidisciplinary | IAudio | IVideo | IConcept | ILearningpath)
