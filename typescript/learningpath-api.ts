...
export type ResourceType = (IAudio | ILearningpath | IArticle | IMultidisciplinary | IConcept | IVideo | IImage)

export type ResourceType = (IImage | IConcept | IMultidisciplinary | ILearningpath | IVideo | IArticle | IAudio)
