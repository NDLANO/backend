...
class LanguageSubtagNotSupportedException(languageSubTag: String)
    extends LanguageNotSupportedException(s"The language subtag '$languageSubTag' is not supported.")

class ScriptSubtagNotSupportedException(scriptSubTag: String)
    extends LanguageNotSupportedException(s"The script subtag '$scriptSubTag' is not supported.")

class RegionSubtagNotSupportedException(regionSubtag: String)
