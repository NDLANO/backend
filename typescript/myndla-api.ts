...
export type ResourceType = (ILearningpath | IAudio | IImage | IConcept | IMultidisciplinary | IVideo | IArticle)

export type ResourceType = (IVideo | IImage | IConcept | IAudio | ILearningpath | IArticle | IMultidisciplinary)
