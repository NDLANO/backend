...
export type ResourceType = (IAudio | IArticle | IConcept | IImage | ILearningpath | IMultidisciplinary | IVideo)

export type ResourceType = (IAudio | IArticle | IConcept | ILearningpath | IMultidisciplinary | IImage | IVideo)
