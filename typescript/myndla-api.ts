...
export type ResourceType = (IArticle | IMultidisciplinary | IImage | IVideo | IConcept | ILearningpath | IAudio)

export type ResourceType = (IConcept | ILearningpath | IVideo | IAudio | IMultidisciplinary | IImage | IArticle)
