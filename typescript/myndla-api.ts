...
export type ResourceType = (IMultidisciplinary | IAudio | IImage | ILearningpath | IArticle | IVideo | IConcept)

export type ResourceType = (IMultidisciplinary | IArticle | IVideo | IConcept | IAudio | IImage | ILearningpath)
