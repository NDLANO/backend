...
export type ResourceType = (IMultidisciplinary | IArticle | IAudio | ILearningpath | IImage | IConcept | IVideo)

export type ResourceType = (IArticle | IImage | IAudio | IConcept | IVideo | IMultidisciplinary | ILearningpath)
