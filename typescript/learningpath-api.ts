...
export type ResourceType = (IVideo | IAudio | IImage | ILearningpath | IArticle | IConcept | IMultidisciplinary)

export type ResourceType = (IConcept | IImage | IVideo | IArticle | IAudio | IMultidisciplinary | ILearningpath)
