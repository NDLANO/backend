...
export type ResourceType = (IMultidisciplinary | IAudio | ILearningpath | IArticle | IVideo | IConcept | IImage)

export type ResourceType = (IImage | IVideo | IArticle | IAudio | IConcept | IMultidisciplinary | ILearningpath)
