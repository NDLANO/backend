...
export type ResourceType = (IConcept | IAudio | IMultidisciplinary | ILearningpath | IImage | IVideo | IArticle)

export type ResourceType = (IAudio | IArticle | IVideo | IMultidisciplinary | IConcept | ILearningpath | IImage)
