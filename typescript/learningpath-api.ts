...
export type ResourceType = (IMultidisciplinary | IImage | IArticle | ILearningpath | IAudio | IConcept | IVideo)

export type ResourceType = (IImage | IMultidisciplinary | IArticle | ILearningpath | IConcept | IAudio | IVideo)
