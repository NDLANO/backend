...
export type ResourceType = (IMultidisciplinary | IConcept | IArticle | IImage | IAudio | IVideo | ILearningpath)

export type ResourceType = (ILearningpath | IVideo | IMultidisciplinary | IAudio | IArticle | IImage | IConcept)
