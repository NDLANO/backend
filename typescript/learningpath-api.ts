...
export type ResourceType = (IVideo | IAudio | ILearningpath | IMultidisciplinary | IConcept | IArticle | IImage)

export type ResourceType = (ILearningpath | IArticle | IConcept | IVideo | IImage | IAudio | IMultidisciplinary)
