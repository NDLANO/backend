...
export type ResourceType = (IAudio | IVideo | IConcept | IArticle | IMultidisciplinary | ILearningpath | IImage)

export type ResourceType = (IImage | IConcept | IMultidisciplinary | ILearningpath | IArticle | IAudio | IVideo)
