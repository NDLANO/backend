...
import no.ndla.draftapi.db.migrationwithdependencies.V23__UpdateH5PDomainForFFVisualElement
import no.ndla.draftapi.{TestEnvironment, UnitSuite}

class V23__UpdateH5PDomainForFFVisualElementTest extends UnitSuite with TestEnvironment {
  val migration = new V23__UpdateH5PDomainForFFVisualElement(props)
