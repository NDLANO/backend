...
class V2_AddUpdatedColoumsTest extends UnitSuite with TestEnvironment {
  ...
  test("add updatedBy and updated on audio object") {
    val before = """{"tags":[{"tags":["leisure","german","hobby"],"language":"en"},{"tags":["fritid","tysk","hobby"],"language":"nb"},{"tags":["fritid","tysk","hobby"],"language":"nn"},{"tags":["爱好"],"language":"zh"},{"tags":["freizeit","deutsch","hobby"],"language":"de"},{"tags":["leisure","german","hobby"]}],"titles":[{"title":"Ich höre gern Musik","language":""}],"copyright":{"authors":[{"name":"NSI Lydproduksjon A/S","type":"Leverandør"}],"license":"by-sa"},"filePaths":[{"filePath":"lektion_2_text_21.mp3","fileSize":94922,"language":"","mimeType":"audio/mpeg"}]}"""
    val expectedAfter = """{"tags":[{"tags":["leisure","german","hobby"],"language":"en"},{"tags":["fritid","tysk","hobby"],"language":"nb"},{"tags":["fritid","tysk","hobby"],"language":"nn"},{"tags":["爱好"],"language":"zh"},{"tags":["freizeit","deutsch","hobby"],"language":"de"},{"tags":["leisure","german","hobby"]}],"titles":[{"title":"Ich höre gern Musik","language":""}],"copyright":{"authors":[{"name":"NSI Lydproduksjon A/S","type":"Leverandør"}],"license":"by-sa"},"filePaths":[{"filePath":"lektion_2_text_21.mp3","fileSize":94922,"language":"","mimeType":"audio/mpeg"}],"updatedBy":"content-import-client","updated":"2017-05-124T14:22:55+0200"}"""
