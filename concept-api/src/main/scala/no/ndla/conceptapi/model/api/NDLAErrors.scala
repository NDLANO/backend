...
object Error {
  ...
  val GENERIC_DESCRIPTION =
    s"Ooops. Something we didn't anticipate occured. We have logged the error, and will look into it. But feel free to contact ${ConceptApiProperties.ContactEmail} if the error persists."
