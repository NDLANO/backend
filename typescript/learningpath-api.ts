...
export type ResourceType = (IMultidisciplinary | IAudio | IVideo | IImage | IConcept | IArticle | ILearningpath)

export type ResourceType = (IConcept | IImage | IMultidisciplinary | IVideo | ILearningpath | IArticle | IAudio)
