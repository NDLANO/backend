...
export type ResourceType = (IVideo | IConcept | IArticle | IMultidisciplinary | IAudio | ILearningpath | IImage)

export type ResourceType = (IConcept | IImage | IAudio | IVideo | IMultidisciplinary | IArticle | ILearningpath)
