...
import no.ndla.common.model.domain.article.{PartialPublishArticleDTO, PartialPublishArticlesBulkDTO}
...
class ArticleApiHttpClient(ArticleBaseUrl: String)(using ndlaClient: NdlaClient, converterService: ConverterService)
