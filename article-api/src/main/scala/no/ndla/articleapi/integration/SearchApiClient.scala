...
trait SearchApiClient {
  this: NdlaClient with ConverterService with ArticleApiPropertiesT =>
  val searchApiClient: SearchApiClient

  class SearchApiClient(SearchApiBaseUrl: String = s"http://${ArticleApiProperties.SearchHost}") extends LazyLogging {
