...
object TestData {
  ...
  val multiDraftSearchSettings: MultiDraftSearchSettings = MultiDraftSearchSettings(
    user = TokenUser(
      ...
      Set(DRAFT_API_WRITE),
      Some(
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6Ik9FSTFNVVU0T0RrNU56TTVNekkyTXpaRE9EazFOMFl3UXpkRE1EUXlPRFZDUXpRM1FISTBNQSJ9..5jpF98NxQZlkQQ5-rxVO3oTkNOQRQLDlAexyDnLiZFY"
      ),
    ),
    query = None,
    noteQuery = None,
