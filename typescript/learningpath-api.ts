...
export type ResourceType = (IArticle | IConcept | IImage | IAudio | IMultidisciplinary | IVideo | ILearningpath)

export type ResourceType = (IAudio | ILearningpath | IMultidisciplinary | IVideo | IImage | IConcept | IArticle)
