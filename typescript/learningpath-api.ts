...
export type ResourceType = (IVideo | IImage | IAudio | IConcept | ILearningpath | IArticle | IMultidisciplinary)

export type ResourceType = (IArticle | IMultidisciplinary | IVideo | IAudio | IConcept | ILearningpath | IImage)
