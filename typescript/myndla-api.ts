...
export type ResourceType = (IAudio | IVideo | IConcept | IImage | IMultidisciplinary | ILearningpath | IArticle)

export type ResourceType = (IConcept | IImage | IArticle | ILearningpath | IVideo | IMultidisciplinary | IAudio)
