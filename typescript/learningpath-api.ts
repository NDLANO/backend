...
export type ResourceType = (IArticle | IMultidisciplinary | IImage | IConcept | ILearningpath | IAudio | IVideo)

export type ResourceType = (IImage | IConcept | IVideo | ILearningpath | IAudio | IArticle | IMultidisciplinary)
