...
export type ResourceType = (IVideo | IAudio | IConcept | ILearningpath | IImage | IArticle | IMultidisciplinary)

export type ResourceType = (IAudio | IImage | ILearningpath | IConcept | IMultidisciplinary | IVideo | IArticle)
