...
export type ResourceType = (IVideo | IMultidisciplinary | ILearningpath | IConcept | IArticle | IAudio | IImage)

export type ResourceType = (IVideo | IMultidisciplinary | IImage | IAudio | IConcept | IArticle | ILearningpath)
