...
export type ResourceType = (IVideo | ILearningpath | IImage | IConcept | IMultidisciplinary | IAudio | IArticle)

export type ResourceType = (IMultidisciplinary | IAudio | IConcept | ILearningpath | IImage | IVideo | IArticle)
