...
export type ResourceType = (IMultidisciplinary | IVideo | IArticle | IImage | IConcept | IAudio | ILearningpath)

export type ResourceType = (IImage | IAudio | IMultidisciplinary | IArticle | IConcept | ILearningpath | IVideo)
