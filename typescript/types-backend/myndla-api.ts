...
export enum ApiPaths {
    getMyndla_apiV1Folders = "/myndla-api/v1/folders",
    postMyndla_apiV1Folders = "/myndla-api/v1/folders",
    getMyndla_apiV1FoldersResources = "/myndla-api/v1/folders/resources",
    getMyndla_apiV1FoldersResourcesRecent = "/myndla-api/v1/folders/resources/recent",
    getMyndla_apiV1FoldersFolder_id = "/myndla-api/v1/folders/{folder-id}",
    deleteMyndla_apiV1FoldersFolder_id = "/myndla-api/v1/folders/{folder-id}",
    patchMyndla_apiV1FoldersFolder_id = "/myndla-api/v1/folders/{folder-id}",
    getMyndla_apiV1FoldersResourcesConnections = "/myndla-api/v1/folders/resources/connections",
    getMyndla_apiV1FoldersResourcesHas_favorited = "/myndla-api/v1/folders/resources/has-favorited",
    postMyndla_apiV1FoldersFolder_idResources = "/myndla-api/v1/folders/{folder-id}/resources",
    getMyndla_apiV1FoldersResourcesRoot = "/myndla-api/v1/folders/resources/root",
    postMyndla_apiV1FoldersResourcesRoot = "/myndla-api/v1/folders/resources/root",
    patchMyndla_apiV1FoldersResourcesResource_id = "/myndla-api/v1/folders/resources/{resource-id}",
    deleteMyndla_apiV1FoldersFolder_idResourcesResource_id = "/myndla-api/v1/folders/{folder-id}/resources/{resource-id}",
    deleteMyndla_apiV1FoldersResourcesRootResource_id = "/myndla-api/v1/folders/resources/root/{resource-id}",
    getMyndla_apiV1FoldersSharedFolder_id = "/myndla-api/v1/folders/shared/{folder-id}",
    patchMyndla_apiV1FoldersSharedFolder_id = "/myndla-api/v1/folders/shared/{folder-id}",
    postMyndla_apiV1FoldersCloneSource_folder_id = "/myndla-api/v1/folders/clone/{source-folder-id}",
    putMyndla_apiV1FoldersSort_resourcesRoot = "/myndla-api/v1/folders/sort-resources/root",
    putMyndla_apiV1FoldersSort_resourcesFolder_id = "/myndla-api/v1/folders/sort-resources/{folder-id}",
    putMyndla_apiV1FoldersSort_subfolders = "/myndla-api/v1/folders/sort-subfolders",
    putMyndla_apiV1FoldersSort_saved = "/myndla-api/v1/folders/sort-saved",
    postMyndla_apiV1FoldersSharedFolder_idSave = "/myndla-api/v1/folders/shared/{folder-id}/save",
    deleteMyndla_apiV1FoldersSharedFolder_idSave = "/myndla-api/v1/folders/shared/{folder-id}/save",
    getMyndla_apiV1Robots = "/myndla-api/v1/robots",
    postMyndla_apiV1Robots = "/myndla-api/v1/robots",
    getMyndla_apiV1RobotsRobot_id = "/myndla-api/v1/robots/{robot-id}",
    putMyndla_apiV1RobotsRobot_id = "/myndla-api/v1/robots/{robot-id}",
    deleteMyndla_apiV1RobotsRobot_id = "/myndla-api/v1/robots/{robot-id}",
    putMyndla_apiV1RobotsRobot_idRobot_status = "/myndla-api/v1/robots/{robot-id}/{robot-status}",
    getMyndla_apiV1Users = "/myndla-api/v1/users",
    patchMyndla_apiV1Users = "/myndla-api/v1/users",
    deleteMyndla_apiV1UsersDelete_personal_data = "/myndla-api/v1/users/delete-personal-data",
    getMyndla_apiV1UsersExport = "/myndla-api/v1/users/export",
    postMyndla_apiV1UsersImport = "/myndla-api/v1/users/import",
    getMyndla_apiV1ConfigConfig_key = "/myndla-api/v1/config/{config-key}",
    postMyndla_apiV1ConfigConfig_key = "/myndla-api/v1/config/{config-key}",
    getMyndla_apiV1Stats = "/myndla-api/v1/stats",
    getMyndla_apiV1StatsFavorites = "/myndla-api/v1/stats/favorites",
    getMyndla_apiV1StatsFavoritesResourcetypeResourceids = "/myndla-api/v1/stats/favorites/{resourceType}/{resourceIds}"
}
