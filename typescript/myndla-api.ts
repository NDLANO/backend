...
export type ResourceType = (IConcept | IAudio | IMultidisciplinary | ILearningpath | IImage | IArticle | IVideo)

export type ResourceType = (IArticle | ILearningpath | IConcept | IAudio | IImage | IVideo | IMultidisciplinary)
