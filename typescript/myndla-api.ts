...
export type ResourceType = (IConcept | IAudio | IVideo | IMultidisciplinary | IImage | IArticle | ILearningpath)

export type ResourceType = (IVideo | IArticle | IConcept | IImage | ILearningpath | IMultidisciplinary | IAudio)
