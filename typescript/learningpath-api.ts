...
export type ResourceType = (IVideo | IConcept | IImage | ILearningpath | IArticle | IAudio | IMultidisciplinary)

export type ResourceType = (ILearningpath | IImage | IAudio | IArticle | IVideo | IConcept | IMultidisciplinary)
