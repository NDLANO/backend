...
export type ResourceType = (IArticle | IMultidisciplinary | IVideo | IConcept | IAudio | ILearningpath | IImage)

export type ResourceType = (IMultidisciplinary | IVideo | IImage | IArticle | IConcept | ILearningpath | IAudio)
