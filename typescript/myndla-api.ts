...
export type ResourceType = (ILearningpath | IAudio | IMultidisciplinary | IImage | IArticle | IConcept | IVideo)

export type ResourceType = (IMultidisciplinary | IImage | IConcept | ILearningpath | IAudio | IVideo | IArticle)
