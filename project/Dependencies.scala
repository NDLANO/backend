...
object Dependencies {
  ...
  object versions {
    ...
    lazy val catsTesting: ModuleID = "org.typelevel" %% "cats-effect-testing-scalatest" % "1.4.0" % Test

    lazy val tapirHttp4sCirce: Seq[sbt.ModuleID] = circe ++ http4s ++ tapir :+ catsEffect :+ catsTesting
