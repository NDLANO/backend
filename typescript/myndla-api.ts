...
export type ResourceType = (IConcept | IVideo | IMultidisciplinary | ILearningpath | IImage | IArticle | IAudio)

export type ResourceType = (IVideo | IArticle | IImage | IMultidisciplinary | IAudio | IConcept | ILearningpath)
