...
export type ResourceType = (IArticle | IConcept | IVideo | IImage | IMultidisciplinary | IAudio | ILearningpath)

export type ResourceType = (IArticle | ILearningpath | IMultidisciplinary | IVideo | IImage | IConcept | IAudio)
