...
export type ResourceType = (IAudio | IArticle | IVideo | IConcept | IImage | ILearningpath | IMultidisciplinary)

export type ResourceType = (ILearningpath | IMultidisciplinary | IAudio | IConcept | IImage | IVideo | IArticle)
