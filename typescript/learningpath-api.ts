...
export type ResourceType = (IArticle | IAudio | IImage | IConcept | IMultidisciplinary | ILearningpath | IVideo)

export type ResourceType = (ILearningpath | IImage | IAudio | IArticle | IConcept | IVideo | IMultidisciplinary)
