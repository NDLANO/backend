...
export type ResourceType = (IConcept | IAudio | ILearningpath | IMultidisciplinary | IVideo | IImage | IArticle)

export type ResourceType = (IConcept | IMultidisciplinary | IAudio | IVideo | IImage | ILearningpath | IArticle)
