...
export type ResourceType = (IConcept | IImage | IAudio | IVideo | ILearningpath | IArticle | IMultidisciplinary)

export type ResourceType = (IMultidisciplinary | IImage | IVideo | ILearningpath | IArticle | IAudio | IConcept)
