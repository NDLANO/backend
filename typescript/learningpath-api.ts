...
export type ResourceType = (ILearningpath | IImage | IConcept | IVideo | IMultidisciplinary | IArticle | IAudio)

export type ResourceType = (IImage | IVideo | ILearningpath | IArticle | IMultidisciplinary | IAudio | IConcept)
