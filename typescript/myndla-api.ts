...
export type ResourceType = (IAudio | ILearningpath | IVideo | IArticle | IImage | IConcept | IMultidisciplinary)

export type ResourceType = (IImage | ILearningpath | IAudio | IConcept | IArticle | IVideo | IMultidisciplinary)
