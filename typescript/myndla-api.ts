...
export type ResourceType = (IImage | IAudio | IArticle | ILearningpath | IConcept | IVideo | IMultidisciplinary)

export type ResourceType = (IVideo | IAudio | IImage | IConcept | IArticle | IMultidisciplinary | ILearningpath)
