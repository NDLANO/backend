...
export type ResourceType = (IArticle | IMultidisciplinary | ILearningpath | IConcept | IAudio | IVideo | IImage)

export type ResourceType = (ILearningpath | IConcept | IMultidisciplinary | IArticle | IAudio | IImage | IVideo)
