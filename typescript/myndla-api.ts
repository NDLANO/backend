...
export type ResourceType = (IVideo | IConcept | IAudio | ILearningpath | IImage | IArticle | IMultidisciplinary)

export type ResourceType = (IImage | IArticle | IVideo | IAudio | IConcept | ILearningpath | IMultidisciplinary)
