...
export type ResourceType = (IVideo | IMultidisciplinary | IArticle | IImage | ILearningpath | IConcept | IAudio)

export type ResourceType = (IAudio | IArticle | IImage | ILearningpath | IVideo | IConcept | IMultidisciplinary)
