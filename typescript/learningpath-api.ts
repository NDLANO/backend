...
export type ResourceType = (IImage | ILearningpath | IAudio | IVideo | IMultidisciplinary | IConcept | IArticle)

export type ResourceType = (IAudio | IConcept | IArticle | ILearningpath | IMultidisciplinary | IImage | IVideo)
