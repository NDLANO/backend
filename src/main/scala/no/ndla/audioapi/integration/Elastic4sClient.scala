...
import no.ndla.audioapi.model.domain.Ndla4sSearchException
...
object Elastic4sClientFactory {
  def getClient(searchServer: String = AudioApiProperties.SearchServer): NdlaE4sClient = {
