...
export type ResourceType = (IImage | IConcept | ILearningpath | IVideo | IArticle | IMultidisciplinary | IAudio)

export type ResourceType = (IMultidisciplinary | IImage | IVideo | IConcept | IArticle | ILearningpath | IAudio)
