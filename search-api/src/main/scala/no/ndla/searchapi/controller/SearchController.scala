      ...
      p match {
        ...
        case Some(params) =>
          ...
          MultiDraftSearchSettings(
            ...
            withIdIn = params.learningResourceIds,
            subjects = params.subjects,
            topics = params.topics,
            resourceTypes = params.resourceTypes,
            learningResourceTypes = params.contextTypes.flatMap(LearningResourceType.valueOf),
            supportedLanguages = params.languageFilter,
            relevanceIds = params.relevanceFilter,
            statusFilter = params.draftStatus.flatMap(DraftStatus.valueOf),
            userFilter = params.users,
            grepCodes = params.grepCodes,
            shouldScroll = shouldScroll,
            searchDecompounded = false,
            aggregatePaths = params.aggregatePaths,
            embedResource = params.embedResource,
            embedId = params.embedId,
            includeOtherStatuses = params.includeOtherStatuses,
            revisionDateFilterFrom = params.revisionDateFilterFrom,
            revisionDateFilterTo = params.revisionDateFilterTo,
            excludeRevisionHistory = params.excludeRevisionLog,
            responsibleIdFilter = params.responsibleIds,
            articleTypes = params.articleTypes,
            filterInactive = params.filterInactive,
