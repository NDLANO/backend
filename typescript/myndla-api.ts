...
export type ResourceType = (IMultidisciplinary | IImage | IAudio | IVideo | IArticle | IConcept | ILearningpath)

export type ResourceType = (ILearningpath | IImage | IMultidisciplinary | IAudio | IVideo | IConcept | IArticle)
