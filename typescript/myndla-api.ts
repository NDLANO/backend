...
export type ResourceType = (IAudio | IVideo | IArticle | ILearningpath | IMultidisciplinary | IConcept | IImage)

export type ResourceType = (IAudio | IArticle | ILearningpath | IConcept | IImage | IMultidisciplinary | IVideo)
