...
export type ResourceType = (IImage | IConcept | ILearningpath | IMultidisciplinary | IAudio | IVideo | IArticle)

export type ResourceType = (ILearningpath | IAudio | IImage | IConcept | IMultidisciplinary | IArticle | IVideo)
