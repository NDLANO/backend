...
export type ResourceType = (IAudio | ILearningpath | IMultidisciplinary | IConcept | IVideo | IArticle | IImage)

export type ResourceType = (IVideo | IImage | ILearningpath | IConcept | IArticle | IAudio | IMultidisciplinary)
