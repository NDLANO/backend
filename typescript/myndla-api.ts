...
export type ResourceType = (IAudio | IVideo | IArticle | ILearningpath | IImage | IConcept | IMultidisciplinary)

export type ResourceType = (IAudio | ILearningpath | IMultidisciplinary | IArticle | IConcept | IVideo | IImage)
