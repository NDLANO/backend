...
export type ResourceType = (IImage | IConcept | IAudio | IVideo | IMultidisciplinary | ILearningpath | IArticle)

export type ResourceType = (IMultidisciplinary | IAudio | IVideo | IConcept | IImage | IArticle | ILearningpath)
