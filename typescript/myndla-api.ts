...
export type ResourceType = (IAudio | IVideo | IArticle | IMultidisciplinary | IImage | IConcept | ILearningpath)

export type ResourceType = (ILearningpath | IAudio | IImage | IVideo | IConcept | IArticle | IMultidisciplinary)
