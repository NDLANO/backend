...
class V12__UpdateNdlaFrontendDomainForFFTest extends UnitSuite with TestEnvironment {
  ...
  test("That ndla hosts are removed") {
    ...
    migration.updateNdlaUrl(
      "https://ndla.no/subjects/subject:3/topic:1:179373/topic:1:170165/resource:1:16145"
    ) should be("/subjects/subject:3/topic:1:179373/topic:1:170165/resource:1:16145")
    migration.updateNdlaUrl(
      "https://ndla.no/subjects/subject:3/topic:1:179373/topic:1:170165/resource:1:16145"
    ) should be("/subjects/subject:3/topic:1:179373/topic:1:170165/resource:1:16145")
  }
