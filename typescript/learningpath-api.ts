...
export type ResourceType = (IMultidisciplinary | ILearningpath | IVideo | IConcept | IArticle | IAudio | IImage)

export type ResourceType = (IConcept | ILearningpath | IImage | IVideo | IArticle | IAudio | IMultidisciplinary)
