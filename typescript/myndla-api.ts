...
export type ResourceType = (IArticle | ILearningpath | IImage | IMultidisciplinary | IVideo | IConcept | IAudio)

export type ResourceType = (IImage | IMultidisciplinary | ILearningpath | IArticle | IAudio | IConcept | IVideo)
