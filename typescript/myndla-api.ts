...
export type ResourceType = (IArticle | IVideo | IAudio | IImage | IConcept | IMultidisciplinary | ILearningpath)

export type ResourceType = (IMultidisciplinary | IVideo | IAudio | ILearningpath | IArticle | IImage | IConcept)
