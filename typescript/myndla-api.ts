...
export type ResourceType = (IVideo | IConcept | IMultidisciplinary | IArticle | IAudio | ILearningpath | IImage)

export type ResourceType = (IConcept | IImage | IArticle | IMultidisciplinary | IVideo | IAudio | ILearningpath)
