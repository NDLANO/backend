...
export type ResourceType = (IMultidisciplinary | ILearningpath | IImage | IVideo | IArticle | IConcept | IAudio)

export type ResourceType = (ILearningpath | IArticle | IAudio | IVideo | IConcept | IMultidisciplinary | IImage)
