...
export type ResourceType = (IMultidisciplinary | IConcept | ILearningpath | IArticle | IAudio | IVideo | IImage)

export type ResourceType = (IMultidisciplinary | IImage | IArticle | IConcept | IAudio | ILearningpath | IVideo)
