...
export type ResourceType = (IAudio | IImage | IArticle | ILearningpath | IMultidisciplinary | IConcept | IVideo)

export type ResourceType = (ILearningpath | IAudio | IConcept | IMultidisciplinary | IVideo | IArticle | IImage)
