...
export type ResourceType = (IVideo | ILearningpath | IMultidisciplinary | IArticle | IAudio | IConcept | IImage)

export type ResourceType = (IMultidisciplinary | IImage | IVideo | IArticle | IAudio | IConcept | ILearningpath)
