...
export type ResourceType = (IArticle | ILearningpath | IAudio | IMultidisciplinary | IVideo | IImage | IConcept)

export type ResourceType = (IAudio | IImage | IMultidisciplinary | ILearningpath | IArticle | IConcept | IVideo)
