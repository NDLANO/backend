...
export type ResourceType = (IMultidisciplinary | IArticle | IImage | IAudio | IConcept | IVideo | ILearningpath)

export type ResourceType = (IArticle | ILearningpath | IVideo | IAudio | IMultidisciplinary | IImage | IConcept)
