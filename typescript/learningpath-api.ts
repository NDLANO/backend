...
export type ResourceType = (IVideo | ILearningpath | IMultidisciplinary | IAudio | IArticle | IImage | IConcept)

export type ResourceType = (IConcept | IAudio | IArticle | IImage | IVideo | ILearningpath | IMultidisciplinary)
