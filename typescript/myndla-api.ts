...
export type ResourceType = (IArticle | IImage | ILearningpath | IAudio | IVideo | IConcept | IMultidisciplinary)

export type ResourceType = (IConcept | IArticle | IAudio | IImage | IVideo | IMultidisciplinary | ILearningpath)
