...
export type ResourceType = (IImage | ILearningpath | IVideo | IAudio | IArticle | IConcept | IMultidisciplinary)

export type ResourceType = (IConcept | IAudio | IArticle | ILearningpath | IVideo | IImage | IMultidisciplinary)
