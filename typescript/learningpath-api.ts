...
export type ResourceType = (IArticle | IMultidisciplinary | ILearningpath | IImage | IAudio | IVideo | IConcept)

export type ResourceType = (IVideo | IImage | ILearningpath | IArticle | IConcept | IAudio | IMultidisciplinary)
