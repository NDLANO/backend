...
object CodeLists {
  ...
  case class Iso639Val(id: String,
      ...
      extends Iso639
  case class Iso15924Val(code: String,
                         no: Int,
                         englishName: String,
                         frenchName: String,
                         pva: Option[String],
  ...
  val iso639Definitions
    : Seq[Iso639Val] = Iso639List_1.items ++ Iso639List_2.items ++ Iso639List_3.items ++ Iso639List_4.items ++ Iso639List_5.items ++ Iso639List_6.items ++ Iso639List_7.items ++ Iso639List_8.items ++ Iso639List_9.items ++ Iso639List_10.items
}
