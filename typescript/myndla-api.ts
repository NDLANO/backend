...
export type ResourceType = (IAudio | IMultidisciplinary | IImage | IConcept | IVideo | ILearningpath | IArticle)

export type ResourceType = (IImage | IMultidisciplinary | IConcept | IAudio | ILearningpath | IVideo | IArticle)
