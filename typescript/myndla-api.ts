...
export type ResourceType = (IConcept | IAudio | IImage | IVideo | IArticle | IMultidisciplinary | ILearningpath)

export type ResourceType = (IConcept | IVideo | IAudio | IImage | IMultidisciplinary | ILearningpath | IArticle)
