...
export type ResourceType = (IAudio | IVideo | IConcept | IArticle | IMultidisciplinary | IImage | ILearningpath)

export type ResourceType = (IAudio | IArticle | IConcept | IMultidisciplinary | IVideo | ILearningpath | IImage)
