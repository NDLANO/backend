...
export type ResourceType = (IVideo | IImage | IArticle | IConcept | IAudio | IMultidisciplinary | ILearningpath)

export type ResourceType = (IArticle | IVideo | IMultidisciplinary | ILearningpath | IImage | IConcept | IAudio)
