...
export type ResourceType = (IConcept | IMultidisciplinary | IVideo | IArticle | IImage | IAudio | ILearningpath)

export type ResourceType = (IImage | IMultidisciplinary | IConcept | IVideo | ILearningpath | IArticle | IAudio)
