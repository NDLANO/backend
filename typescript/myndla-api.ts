...
export type ResourceType = (IVideo | IImage | IAudio | IMultidisciplinary | ILearningpath | IArticle | IConcept)

export type ResourceType = (IImage | IAudio | IConcept | IMultidisciplinary | IVideo | IArticle | ILearningpath)
