...
export type ResourceType = (IAudio | IConcept | IArticle | IVideo | ILearningpath | IMultidisciplinary | IImage)

export type ResourceType = (IImage | IArticle | IConcept | IAudio | ILearningpath | IVideo | IMultidisciplinary)
