...
export type ResourceType = (IImage | IArticle | IMultidisciplinary | IAudio | ILearningpath | IVideo | IConcept)

export type ResourceType = (IMultidisciplinary | IVideo | IConcept | ILearningpath | IArticle | IImage | IAudio)
