...
export type ResourceType = (IConcept | ILearningpath | IVideo | IAudio | IArticle | IMultidisciplinary | IImage)

export type ResourceType = (ILearningpath | IConcept | IVideo | IAudio | IImage | IArticle | IMultidisciplinary)
