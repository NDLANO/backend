...
export type ResourceType = (IImage | IVideo | ILearningpath | IMultidisciplinary | IConcept | IAudio | IArticle)

export type ResourceType = (IAudio | IArticle | IVideo | IImage | IConcept | IMultidisciplinary | ILearningpath)
