...
export type ResourceType = (IAudio | ILearningpath | IConcept | IVideo | IArticle | IMultidisciplinary | IImage)

export type ResourceType = (IImage | IConcept | IAudio | IVideo | ILearningpath | IMultidisciplinary | IArticle)
