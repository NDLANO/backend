...
export type ResourceType = (IImage | IArticle | IAudio | IVideo | IConcept | IMultidisciplinary | ILearningpath)

export type ResourceType = (ILearningpath | IImage | IArticle | IVideo | IMultidisciplinary | IAudio | IConcept)
