...
export type ResourceType = (IMultidisciplinary | IVideo | IAudio | ILearningpath | IImage | IConcept | IArticle)

export type ResourceType = (IConcept | IImage | IArticle | IVideo | ILearningpath | IMultidisciplinary | IAudio)
