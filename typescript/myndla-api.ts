...
export type ResourceType = (ILearningpath | IVideo | IMultidisciplinary | IArticle | IAudio | IImage | IConcept)

export type ResourceType = (IImage | IMultidisciplinary | IArticle | IConcept | IAudio | IVideo | ILearningpath)
