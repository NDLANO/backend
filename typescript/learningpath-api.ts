...
export type ResourceType = (IConcept | IMultidisciplinary | ILearningpath | IAudio | IImage | IArticle | IVideo)

export type ResourceType = (IVideo | IArticle | IMultidisciplinary | ILearningpath | IAudio | IConcept | IImage)
