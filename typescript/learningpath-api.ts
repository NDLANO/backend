...
export type ResourceType = (ILearningpath | IAudio | IImage | IVideo | IMultidisciplinary | IArticle | IConcept)

export type ResourceType = (ILearningpath | IMultidisciplinary | IConcept | IImage | IVideo | IAudio | IArticle)
