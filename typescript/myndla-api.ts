...
export type ResourceType = (ILearningpath | IArticle | IConcept | IImage | IVideo | IMultidisciplinary | IAudio)

export type ResourceType = (IVideo | IConcept | IArticle | IMultidisciplinary | ILearningpath | IImage | IAudio)
