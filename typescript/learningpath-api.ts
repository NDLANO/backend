...
export type ResourceType = (IImage | IVideo | IMultidisciplinary | IConcept | IArticle | IAudio | ILearningpath)

export type ResourceType = (IAudio | ILearningpath | IConcept | IImage | IVideo | IMultidisciplinary | IArticle)
