...
export type ResourceType = (IAudio | IImage | IArticle | IMultidisciplinary | IConcept | IVideo | ILearningpath)

export type ResourceType = (ILearningpath | IImage | IVideo | IArticle | IMultidisciplinary | IConcept | IAudio)
