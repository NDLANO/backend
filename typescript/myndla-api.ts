...
export type ResourceType = (IArticle | IConcept | IMultidisciplinary | IAudio | IImage | ILearningpath | IVideo)

export type ResourceType = (IAudio | IVideo | IImage | IConcept | ILearningpath | IArticle | IMultidisciplinary)
