...
export type ResourceType = (IConcept | IMultidisciplinary | IImage | IVideo | IAudio | IArticle | ILearningpath)

export type ResourceType = (IAudio | ILearningpath | IConcept | IImage | IMultidisciplinary | IArticle | IVideo)
