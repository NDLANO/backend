...
export type ResourceType = (IImage | ILearningpath | IArticle | IAudio | IVideo | IMultidisciplinary | IConcept)

export type ResourceType = (IArticle | ILearningpath | IMultidisciplinary | IConcept | IImage | IAudio | IVideo)
