...
export type ResourceType = (IConcept | IImage | IAudio | ILearningpath | IVideo | IMultidisciplinary | IArticle)

export type ResourceType = (IArticle | IConcept | IMultidisciplinary | IVideo | IAudio | IImage | ILearningpath)
