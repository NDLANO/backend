...
export type ResourceType = (IConcept | IMultidisciplinary | IArticle | IImage | IAudio | ILearningpath | IVideo)

export type ResourceType = (ILearningpath | IConcept | IArticle | IVideo | IAudio | IMultidisciplinary | IImage)
