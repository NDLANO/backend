...
export type ResourceType = (ILearningpath | IAudio | IArticle | IImage | IVideo | IMultidisciplinary | IConcept)

export type ResourceType = (IAudio | ILearningpath | IConcept | IVideo | IMultidisciplinary | IArticle | IImage)
