...
export type ResourceType = (IConcept | IAudio | ILearningpath | IImage | IMultidisciplinary | IArticle | IVideo)

export type ResourceType = (IMultidisciplinary | IImage | IVideo | IArticle | IConcept | IAudio | ILearningpath)
