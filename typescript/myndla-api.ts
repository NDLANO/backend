...
export type ResourceType = (ILearningpath | IAudio | IImage | IVideo | IConcept | IMultidisciplinary | IArticle)

export type ResourceType = (IImage | IArticle | IVideo | IAudio | ILearningpath | IMultidisciplinary | IConcept)
