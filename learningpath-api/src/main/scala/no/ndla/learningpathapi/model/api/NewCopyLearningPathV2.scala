...
object NewCopyLearningPathV2 {
  implicit val encoder: Encoder[NewCopyLearningPathV2] = deriveEncoder
  implicit val decoder: Decoder[NewCopyLearningPathV2] = deriveDecoder
}
