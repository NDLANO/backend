...
export type ResourceType = (IMultidisciplinary | IImage | IVideo | ILearningpath | IConcept | IAudio | IArticle)

export type ResourceType = (IAudio | ILearningpath | IArticle | IMultidisciplinary | IImage | IConcept | IVideo)
