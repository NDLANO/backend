...
export type ResourceType = (IArticle | IConcept | ILearningpath | IImage | IAudio | IVideo | IMultidisciplinary)

export type ResourceType = (ILearningpath | IVideo | IImage | IConcept | IMultidisciplinary | IAudio | IArticle)
