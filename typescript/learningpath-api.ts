...
export type ResourceType = (IAudio | IMultidisciplinary | ILearningpath | IArticle | IConcept | IImage | IVideo)

export type ResourceType = (IAudio | IMultidisciplinary | IImage | IArticle | IConcept | ILearningpath | IVideo)
