...
export type ResourceType = (ILearningpath | IImage | IMultidisciplinary | IVideo | IAudio | IArticle | IConcept)

export type ResourceType = (IMultidisciplinary | IAudio | IImage | IConcept | IVideo | ILearningpath | IArticle)
