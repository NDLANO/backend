...
export type ResourceType = (IMultidisciplinary | IConcept | ILearningpath | IAudio | IVideo | IArticle | IImage)

export type ResourceType = (IArticle | IMultidisciplinary | IAudio | ILearningpath | IVideo | IImage | IConcept)
