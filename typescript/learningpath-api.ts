...
export type ResourceType = (IConcept | ILearningpath | IArticle | IMultidisciplinary | IImage | IVideo | IAudio)

export type ResourceType = (IVideo | IArticle | IConcept | IImage | IAudio | ILearningpath | IMultidisciplinary)
