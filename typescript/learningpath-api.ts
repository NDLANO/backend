...
export type ResourceType = (IImage | ILearningpath | IConcept | IMultidisciplinary | IArticle | IVideo | IAudio)

export type ResourceType = (IImage | IVideo | IAudio | ILearningpath | IMultidisciplinary | IConcept | IArticle)
