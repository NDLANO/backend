...
export type ResourceType = (IArticle | ILearningpath | IVideo | IMultidisciplinary | IImage | IAudio | IConcept)

export type ResourceType = (IArticle | IMultidisciplinary | IVideo | IConcept | IImage | IAudio | ILearningpath)
