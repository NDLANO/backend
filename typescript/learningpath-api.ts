...
export type ResourceType = (IMultidisciplinary | IArticle | IAudio | IConcept | IImage | IVideo | ILearningpath)

export type ResourceType = (IImage | IConcept | IVideo | IAudio | IMultidisciplinary | IArticle | ILearningpath)
