...
export type ResourceType = (IConcept | IVideo | IAudio | IImage | ILearningpath | IMultidisciplinary | IArticle)

export type ResourceType = (IConcept | ILearningpath | IArticle | IVideo | IMultidisciplinary | IImage | IAudio)
