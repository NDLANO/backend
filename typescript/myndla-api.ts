...
export type ResourceType = (IMultidisciplinary | IVideo | ILearningpath | IConcept | IArticle | IAudio | IImage)

export type ResourceType = (IArticle | IImage | IVideo | IConcept | IAudio | ILearningpath | IMultidisciplinary)
