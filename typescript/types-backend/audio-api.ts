...
export type ListAudioMetaInformationDTO = schemas["::_AudioMetaInformationDTO"];
...
export type IAudioSummarySearchResultDTO =
  schemas["AudioSummarySearchResultDTO"];
...
export type IList_AudioMetaInformationDTO =
  schemas["List_AudioMetaInformationDTO"];
...
export type INil = schemas["Nil"];
export type INotFoundWithSupportedLanguages =
  schemas["NotFoundWithSupportedLanguages"];
...
export type ISeriesSummarySearchResultDTO =
  schemas["SeriesSummarySearchResultDTO"];
...
export type IUpdatedAudioMetaInformationDTO =
  schemas["UpdatedAudioMetaInformationDTO"];
