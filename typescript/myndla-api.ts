...
export type ResourceType = (IMultidisciplinary | IConcept | IAudio | IArticle | IImage | ILearningpath | IVideo)

export type ResourceType = (ILearningpath | IVideo | IMultidisciplinary | IArticle | IConcept | IAudio | IImage)
