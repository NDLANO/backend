...
export type ResourceType = (IArticle | ILearningpath | IConcept | IMultidisciplinary | IAudio | IImage | IVideo)

export type ResourceType = (IMultidisciplinary | IAudio | IArticle | IVideo | ILearningpath | IImage | IConcept)
