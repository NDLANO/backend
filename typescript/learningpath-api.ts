...
export type ResourceType = (IVideo | IAudio | IConcept | ILearningpath | IMultidisciplinary | IImage | IArticle)

export type ResourceType = (IArticle | IMultidisciplinary | IImage | IVideo | ILearningpath | IAudio | IConcept)
