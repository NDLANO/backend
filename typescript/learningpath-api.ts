...
export type ResourceType = (IImage | IArticle | ILearningpath | IAudio | IConcept | IVideo | IMultidisciplinary)

export type ResourceType = (IAudio | IArticle | IVideo | IConcept | IMultidisciplinary | IImage | ILearningpath)
