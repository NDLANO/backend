...
export type ResourceType = (IMultidisciplinary | IAudio | IArticle | IImage | ILearningpath | IConcept | IVideo)

export type ResourceType = (IAudio | IImage | IArticle | IMultidisciplinary | IConcept | ILearningpath | IVideo)
