...
export type ResourceType = (ILearningpath | IMultidisciplinary | IImage | IArticle | IAudio | IVideo | IConcept)

export type ResourceType = (IVideo | IArticle | IMultidisciplinary | IImage | IConcept | IAudio | ILearningpath)
