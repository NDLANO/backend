...
export type ResourceType = (IVideo | IImage | IConcept | ILearningpath | IAudio | IMultidisciplinary | IArticle)

export type ResourceType = (ILearningpath | IVideo | IMultidisciplinary | IAudio | IImage | IConcept | IArticle)
