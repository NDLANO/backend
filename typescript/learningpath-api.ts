...
export type ResourceType = (IArticle | ILearningpath | IConcept | IVideo | IAudio | IMultidisciplinary | IImage)

export type ResourceType = (IAudio | IImage | ILearningpath | IMultidisciplinary | IConcept | IVideo | IArticle)
