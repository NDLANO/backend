...
export type ResourceType = (ILearningpath | IArticle | IAudio | IMultidisciplinary | IImage | IConcept | IVideo)

export type ResourceType = (IArticle | IAudio | ILearningpath | IImage | IVideo | IMultidisciplinary | IConcept)
