...
export type ResourceType = (IVideo | IMultidisciplinary | IAudio | IArticle | IConcept | IImage | ILearningpath)

export type ResourceType = (IVideo | IImage | IConcept | IArticle | ILearningpath | IMultidisciplinary | IAudio)
