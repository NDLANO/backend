...
export type ResourceType = (ILearningpath | IArticle | IConcept | IMultidisciplinary | IImage | IVideo | IAudio)

export type ResourceType = (IImage | IVideo | IArticle | IAudio | IMultidisciplinary | IConcept | ILearningpath)
