...
case class LearningPathSummaryV2DTO(
                                     ...
                                     @description("The titles of the learningpath") title: TitleDTO,
                                     @description("The descriptions of the learningpath") description: DescriptionDTO,
                                     @description("The introductions of the learningpath") introduction: IntroductionDTO,
