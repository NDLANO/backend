...
class WriteServiceTest extends UnitSuite with TestEnvironment {
  ...
  test("That updateStatus indexes the updated article") {
    ...
    when(searchApiClient.indexDraft(any[Draft], any, any)(any)).thenReturn(updatedAndInserted)
    ...
    verify(searchApiClient, times(1)).indexDraft(argCap2.capture(), any, any)(any)
