...
export type ResourceType = (IImage | IAudio | IConcept | IArticle | IVideo | ILearningpath | IMultidisciplinary)

export type ResourceType = (IArticle | IConcept | IMultidisciplinary | IVideo | IImage | ILearningpath | IAudio)
