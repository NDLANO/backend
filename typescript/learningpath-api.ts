...
export type ResourceType = (IArticle | IConcept | IAudio | IMultidisciplinary | ILearningpath | IImage | IVideo)

export type ResourceType = (IImage | ILearningpath | IVideo | IAudio | IArticle | IMultidisciplinary | IConcept)
