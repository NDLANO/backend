...
import no.ndla.draftapi.integration.{ImageApiClient, ImageWithCopyright}

import scala.util.{Failure, Try}

/** In-process implementation of draft-api's [[ImageApiClient]] trait that delegates to image-api's
  ...
  * [[no.ndla.imageapi.ComponentRegistry]] and [[no.ndla.draftapi.ComponentRegistry]] in the monolith.
  */
class ImageForDraftApiInProcessClient(producerCr: => no.ndla.imageapi.ComponentRegistry) extends ImageApiClient {
