...
export type ResourceType = (IMultidisciplinary | IConcept | IArticle | IVideo | ILearningpath | IAudio | IImage)

export type ResourceType = (IVideo | IAudio | IMultidisciplinary | ILearningpath | IImage | IConcept | IArticle)
