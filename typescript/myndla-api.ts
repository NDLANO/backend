...
export type ResourceType = (IMultidisciplinary | ILearningpath | IConcept | IArticle | IAudio | IVideo | IImage)

export type ResourceType = (IImage | ILearningpath | IConcept | IArticle | IVideo | IAudio | IMultidisciplinary)
