...
export type ResourceType = (IVideo | IAudio | ILearningpath | IArticle | IMultidisciplinary | IImage | IConcept)

export type ResourceType = (IImage | ILearningpath | IConcept | IVideo | IArticle | IMultidisciplinary | IAudio)
