...
export type ResourceType = (IConcept | IArticle | ILearningpath | IVideo | IImage | IMultidisciplinary | IAudio)

export type ResourceType = (IArticle | IMultidisciplinary | IVideo | IImage | IConcept | ILearningpath | IAudio)
