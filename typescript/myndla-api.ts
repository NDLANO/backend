...
export type ResourceType = (IConcept | IAudio | IVideo | IImage | IArticle | ILearningpath | IMultidisciplinary)

export type ResourceType = (IImage | IConcept | IMultidisciplinary | IAudio | IArticle | IVideo | ILearningpath)
