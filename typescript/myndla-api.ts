...
export type ResourceType = (IImage | IVideo | IMultidisciplinary | ILearningpath | IAudio | IConcept | IArticle)

export type ResourceType = (ILearningpath | IImage | IVideo | IAudio | IMultidisciplinary | IArticle | IConcept)
