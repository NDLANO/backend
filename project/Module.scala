...
trait Module {
  ...
  lazy val commonSettings: Seq[Def.Setting[?]] = Seq(
    ...
    Compile / unmanagedResources += (ThisBuild / baseDirectory).value / "log4j" / "log4j2.yaml",
    Test / unmanagedResources += (ThisBuild / baseDirectory).value / "log4j" / "test" / "log4j2.yaml",
