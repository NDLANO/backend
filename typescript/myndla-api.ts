...
export type ResourceType = (IAudio | IMultidisciplinary | IArticle | IConcept | IVideo | ILearningpath | IImage)

export type ResourceType = (IImage | IAudio | IMultidisciplinary | IConcept | IArticle | ILearningpath | IVideo)
