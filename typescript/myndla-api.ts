...
export type ResourceType = (IConcept | IArticle | ILearningpath | IAudio | IVideo | IImage | IMultidisciplinary)

export type ResourceType = (ILearningpath | IConcept | IMultidisciplinary | IAudio | IImage | IArticle | IVideo)
