...
export type ResourceType = (IImage | IVideo | ILearningpath | IAudio | IArticle | IMultidisciplinary | IConcept)

export type ResourceType = (IAudio | IConcept | IMultidisciplinary | IImage | IVideo | IArticle | ILearningpath)
