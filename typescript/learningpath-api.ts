...
export type ResourceType = (IArticle | IImage | IMultidisciplinary | ILearningpath | IConcept | IVideo | IAudio)

export type ResourceType = (IAudio | IArticle | IVideo | ILearningpath | IMultidisciplinary | IConcept | IImage)
