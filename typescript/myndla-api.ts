...
export type ResourceType = (IMultidisciplinary | IConcept | IImage | IAudio | IArticle | ILearningpath | IVideo)

export type ResourceType = (IAudio | IMultidisciplinary | IVideo | IImage | IConcept | ILearningpath | IArticle)
