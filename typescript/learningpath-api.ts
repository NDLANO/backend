...
export type ResourceType = (IAudio | IMultidisciplinary | IArticle | IVideo | IConcept | IImage | ILearningpath)

export type ResourceType = (IArticle | IConcept | IVideo | ILearningpath | IMultidisciplinary | IImage | IAudio)
