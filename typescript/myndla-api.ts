...
export type ResourceType = (IAudio | IArticle | ILearningpath | IConcept | IVideo | IMultidisciplinary | IImage)

export type ResourceType = (IArticle | IAudio | IConcept | ILearningpath | IImage | IVideo | IMultidisciplinary)
