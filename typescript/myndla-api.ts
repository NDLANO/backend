...
export type ResourceType = (ILearningpath | IMultidisciplinary | IArticle | IConcept | IAudio | IImage | IVideo)

export type ResourceType = (IImage | ILearningpath | IVideo | IMultidisciplinary | IAudio | IConcept | IArticle)
