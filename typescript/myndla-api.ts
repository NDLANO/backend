...
export type ResourceType = (IConcept | IImage | IVideo | ILearningpath | IArticle | IMultidisciplinary | IAudio)

export type ResourceType = (IVideo | IAudio | IArticle | ILearningpath | IImage | IConcept | IMultidisciplinary)
