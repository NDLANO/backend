...
export type ResourceType = (IArticle | IAudio | IMultidisciplinary | IConcept | ILearningpath | IVideo | IImage)

export type ResourceType = (IMultidisciplinary | IAudio | IVideo | IArticle | IImage | ILearningpath | IConcept)
