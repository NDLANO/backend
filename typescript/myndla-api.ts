...
export type ResourceType = (IVideo | IConcept | IAudio | ILearningpath | IMultidisciplinary | IArticle | IImage)

export type ResourceType = (IArticle | IVideo | IConcept | IMultidisciplinary | IImage | IAudio | ILearningpath)
