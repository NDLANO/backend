...
export type ResourceType = (ILearningpath | IConcept | IMultidisciplinary | IVideo | IImage | IArticle | IAudio)

export type ResourceType = (IVideo | IImage | IMultidisciplinary | IArticle | IAudio | IConcept | ILearningpath)
