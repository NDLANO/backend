...
export type ResourceType = (IVideo | IConcept | ILearningpath | IMultidisciplinary | IImage | IArticle | IAudio)

export type ResourceType = (IConcept | IMultidisciplinary | IAudio | IArticle | IImage | ILearningpath | IVideo)
