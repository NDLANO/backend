...
export type ResourceType = (IMultidisciplinary | IVideo | IConcept | IArticle | IAudio | ILearningpath | IImage)

export type ResourceType = (IImage | IArticle | IMultidisciplinary | ILearningpath | IConcept | IVideo | IAudio)
