...
export type ResourceType = (IConcept | IMultidisciplinary | IVideo | IAudio | IArticle | ILearningpath | IImage)

export type ResourceType = (ILearningpath | IMultidisciplinary | IVideo | IAudio | IImage | IConcept | IArticle)
