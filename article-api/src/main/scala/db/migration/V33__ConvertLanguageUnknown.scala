...
import no.ndla.articleapi.model.domain.{Article, DBArticleSupport}
...
class V33__ConvertLanguageUnknown extends BaseJavaMigration with DBArticleSupport with ArticleApiPropertiesT {
