...
export type ResourceType = (ILearningpath | IArticle | IMultidisciplinary | IImage | IVideo | IConcept | IAudio)

export type ResourceType = (IAudio | IMultidisciplinary | IConcept | IVideo | IImage | ILearningpath | IArticle)
