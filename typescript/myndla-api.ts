...
export type ResourceType = (IArticle | IVideo | ILearningpath | IConcept | IImage | IMultidisciplinary | IAudio)

export type ResourceType = (IVideo | IConcept | IMultidisciplinary | ILearningpath | IImage | IArticle | IAudio)
