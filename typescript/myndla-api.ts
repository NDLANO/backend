...
export type ResourceType = (IAudio | IVideo | IMultidisciplinary | IImage | IConcept | ILearningpath | IArticle)

export type ResourceType = (IImage | ILearningpath | IMultidisciplinary | IAudio | IConcept | IVideo | IArticle)
